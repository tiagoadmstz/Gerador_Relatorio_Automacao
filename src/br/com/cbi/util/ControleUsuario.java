...
import br.com.cbi.entities.Usuario;
...
public class ControleUsuario {
     ...
     * nulo.
     * @return um boolean com resultado da comparação
     */
    public static boolean verificaSenhasCoinscidentes(JTextField senha1, JTextField senha2, JLabel lbInformacao) {
        senha2.addCaretListener((CaretEvent e) -> {
        ...
        return Objects.equals(senha1.getText(), senha2.getText());
    }
     ...
     */
    public static boolean verificaForcaSenha(JTextField senha, JLabel lbForca, JProgressBar barraForca) {
        CaretListener ct;
        ct = (CaretEvent e) -> {
        ...
        return forcarSenha(senha.getText()) == 3;
    }
     ...
     * @return um boolean true caso a senha contenha todos os requisitos
     */
    private static int forcarSenha(String senha) {
