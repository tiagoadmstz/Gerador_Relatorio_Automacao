...
import br.com.cbi.listeners.ListenerPatternAdapter;
...
public class JasperUtil {
    ...
    private static void viewReportFrame(String titulo, JasperPrint print, Image image) {
        ...
        saveContributor.stream().filter(sc -> !sc.getDescription().equals("PDF (*.pdf)")).forEach(viewer::removeSaveContributor);
