...
public final class Form_Splash extends ManipulaFrames {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/cbi/img/logoSplash.png"))); // NOI18N

        jLabel2.setText("versão 0.0.1 (Beta)");

        jLabel3.setText("CBI - Sistema de Gestão Integrada");
